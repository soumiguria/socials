        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(
              ...
              child: Obx(() => ListView.separated(
                  ...
                  itemCount: controller.accountDetailsModelObj.value
                      .fortysixItemList.value.length,
                  itemBuilder: (context, index) {
                    FortysixItemModel model = controller.accountDetailsModelObj
                        .value.fortysixItemList.value[index];
