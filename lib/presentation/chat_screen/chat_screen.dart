...
import 'package:soumi_s_application7/widgets/app_bar/appbar_title.dart';
import 'package:soumi_s_application7/widgets/app_bar/appbar_trailing_circleimage.dart';
...
class ChatScreen extends GetWidget<ChatController> {
  ...
  Widget _buildDelivered({required String deliveredText}) {
    return Row(mainAxisAlignment: MainAxisAlignment.end, children: [
      ...
      CustomImageView(
          imagePath: ImageConstant.imgCheckmarkDeepPurpleA200,
          height: 10.v,
          width: 15.h,
